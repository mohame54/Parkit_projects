...
class Predictor:
    def __init__(self,model_path='C:\\Users\\HP\\OneDrive\\Desktop\Parkit\\best.torchscript',**nmskwargs):
        try:
    ...
    def from_video(self,vid_path,out_path='vid.avi',with_conf=False,fps=20):
        ...
        out = cv2.VideoWriter(f'{out_path}',cv2.VideoWriter_fourcc('M','J','P','G'), fps, (frame_width,frame_height)) # making a new video
        while cap.isOpened():
            ret,img = cap.read()
            if ret:
                im = img[...,::-1]
